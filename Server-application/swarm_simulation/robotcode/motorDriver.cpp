...
//            angleDeg = map(angleDeg, -180, 180, 0, 360); //convert to 0 till 360
...
//            }
            ...
            debugE("* pos: %d, %d", udpData.newX, udpData.newY);
